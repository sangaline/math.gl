...
type Array16 = [
  ...
  // set(number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number);
  setRowMajor(m00 : number, m01 : number, m02 : number, m03 : number, m10 : number, m11 : number, m12 : number, m13 : number, m20 : number, m21 : number, m22 : number, m23 : number, m30 : number, m31 : number, m32 : number, m33 : number);
  ...
  */ 
  ...
  getScale(result : [number, number, number]) : Matrix4;

  // Gets the translation portion, assuming the matrix is a affine transformation matrix.
  getTranslation(result : [number, number, number]) : Matrix4;

  /*
  // Gets upper left 3x3 pure rotation matrix (non-scaling), assume affine transformation matrix
  getRotation(
    result = [number, number, number, number, number, number, number, number, number],
    scaleResult = null
  ) {
