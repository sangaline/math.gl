import { Vector2, Vector3, Vector4, Matrix4 } from 'math.gl';
import { AxisAlignedBoundingBox, Plane } from '@math.gl/culling';
import Ellipsoid from './ellipsoid';
import IntersectionTests from '';
import Ray from '';
...
class EllipsoidTangentPlane {
  ...
  * @param {Ellipsoid} [ellipsoid=Ellipsoid.WGS84] The ellipsoid to use.
  */
  fromPoints = function(cartesians, ellipsoid) {
    //>>includeStart('debug', pragmas.debug);
